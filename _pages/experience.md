...
* Working on the software/compiler stack for domain specific accelerators for future Intel products
  * Performance analysis of compiler design with RTL co-simulation
  * End-to-end system simulation with custom compiler and accelerator with CPU models running on Simics
  * ProtoC compiler plugin development for offload to custom accelerators 
